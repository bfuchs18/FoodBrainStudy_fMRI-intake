...
# note: meets_inclusion_criteria generated in determine_analysis_sample.R

intake_long_analyze <- intake_long[intake_long$sub %in% meets_inclusion_criteria$sub[meets_inclusion_criteria$overall_include_b20 == 1], ]
