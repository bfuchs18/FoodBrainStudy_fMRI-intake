...
intake_feis_data <- merge(grams_ps_psquad_feis_data, kcal_ps_feis_data, by = 'sub')
...
intake_feis_data <- merge(intake_feis_data, led_grams_ps_feis_data, by = 'sub')
...
intake_feis_data <- merge(intake_feis_data, led_kcal_ps_feis_data, by = 'sub')
...
intake_feis_data <- merge(intake_feis_data, hed_grams_ps_feis_data, by = 'sub')
...
intake_feis_data <- merge(intake_feis_data, hed_kcal_ps_feis_data, by = 'sub')
