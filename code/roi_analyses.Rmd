...
LargevSmall_betas_clean<-HighvLow_betas[!(LargevSmall_betas$File=="File"),]
...
```{r mixed models - PS response vs PSE, include=FALSE}
...
# summaries
anova(PS_roi1, PS_roi1_q) # test whether quadratic interaction improves model fit -- it does, include it 
summary(PS_roi1_q) # result - brain moderates linear and quad

anova(PS_roi2, PS_roi2_q) # test whether quadratic interaction improves model fit -- it does not, don't include it 
summary(PS_roi2) # result - brain moderates linear

anova(PS_roi4, PS_roi4_q) # test whether quadratic interaction improves model fit -- it does not, don't include it 
summary(PS_roi4) # null
...
anova(PS_roi16, PS_roi16_q) # test whether quadratic interaction improves model fit -- it does not, don't include it 
summary(PS_roi16) # null

anova(PS_roi32, PS_roi32_q) # test whether quadratic interaction improves model fit -- it does, include it 
summary(PS_roi32_q) # trend - brain moderates linear (trend) and quad (trend)
...
anova(PS_roi256, PS_roi256_q) # test whether quadratic interaction improves model fit -- it does not, don't include it 
summary(PS_roi256) # null

anova(PS_roi512, PS_roi512_q) # test whether quadratic interaction improves model fit -- it does, include it 
summary(PS_roi512_q) # result - brain moderates linear and quad (trend)

anova(PS_roi1024, PS_roi1024_q) # test whether quadratic interaction improves model fit -- it does, include it 
summary(PS_roi1024_q) # result - brain moderates linear and quad (trend)
